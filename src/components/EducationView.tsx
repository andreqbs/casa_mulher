        ...
        <div className="px-6 py-4 space-y-8 animate-in fade-in duration-500 relative">
            ...
            <div className="space-y-4">
                ...
                <p className="text-slate-500 text-sm leading-relaxed">
                    Entender os padrões de comportamento é o primeiro passo para encontrar a sua força e recuperar sua
                    liberdade. Você não está sozinha nesta jornada.
                </p>
            </div>
            ...
            <div className="bg-slate-50 rounded-3xl p-6 space-y-4">
                ...
                <div className="flex items-center gap-4">
                    <button
                        className="w-10 h-10 bg-brand-purple rounded-full flex items-center justify-center text-white shadow-md">
            ...
            <p className="text-xs text-slate-500 leading-relaxed italic">
                O ciclo da violência, identificado pela psicóloga Lenore Walker, é um padrão de comportamento que se
                repete em relacionamentos abusivos, tornando cada vez mais difícil para a mulher identificar o perigo
                real. Conhecer essas fases é um ato de coragem e autodefesa.
            </p>
            ...
            <div
                className="bg-brand-purple/60 rounded-[40px] p-8 text-center text-white space-y-6 shadow-xl backdrop-blur-sm">
                <h3 className="text-2xl font-bold">Você merece viver em paz.</h3>
                <p className="text-sm opacity-90">
                    Se você se identificou com essas fases, saiba que existem caminhos seguros para sair desse ciclo.
